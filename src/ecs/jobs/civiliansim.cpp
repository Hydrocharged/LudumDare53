...
void ecs::jobs::CivilianSim::run(flecs::entity e, ecs::components::Human& human, ecs::components::Civilian& civilian) {
	...
	// (mood/order rate drains if waiting over an hour without confirmation, cancels after 2 hours without confirmation and order rate plummets)
	...
	// (order rate determined by variable, number of locations, and delivery fee)
